...
# ----------------MobileViT v2-----------------
            ...
            width_multiplier = args[-1]
            assert width_multiplier in [0.5, 0.75, 1, 1.25, 1.5, 1.75, 2]
            c1, c2 = ch[f], int(args[0] * width_multiplier) 
            args = [c1, c2, *args[1:-1]]
            ...
            c1, c2 = ch[f], int(args[0] * width_multiplier) 
            attn_dim = int(args[1] * width_multiplier) 

            args = [c1, attn_dim, 2, args[2], (2,2)]
...
# ----------------ConvDu-------------------
            ...
            args = [c1, c2, *args[1:]]
# --------------StackedAttentionBlock------
        elif m is StackedAttentionBlock:
            c1, c2 = ch[f], args[0]
            args = [ *args[0:]]

# --------------StackedAttentionBlock------
        elif m is MultiScaleAttentionBlock:
            c1, c2 = ch[f], args[0]
            args = [c1]

# --------------CustomConvAttentionBlock------
        elif m is CustomConvAttentionBlock:
            c1, c2 = ch[f], ch[f]
            args = [c1, *args[0:]]
